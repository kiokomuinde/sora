...
class ProfileSettingsScreen extends StatelessWidget {
  ...
  const ProfileSettingsScreen({Key? key, required this.authService}) : super(key: key);
                  ...
                  Center(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                          'We are working on a comprehensive profile management section for your account.',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: isLargeScreen ? 18 : (isMediumScreen ? 16 : 14),
